...
plan="$root_dir/query_plans/imdb_duckdb/yannakakis/1a.json"
...
cargo +nightly run --release --manifest-path="../intermediate_to_df_plan/Cargo.toml" --bin exec_ir_plans -- --plans "$plan" --data "$parquet_data" -o "$out_folder" -t $timings --repetitions 10
